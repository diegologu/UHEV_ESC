...
void setup() {                // The setup function is called ONCE on boot-up
  ...
  cli();
  CMP0_CR1 |= B00000001; //Enable CMP (comparator); Quitar sample y window
  CMP0_CR0 = 0x00; // Desactivar filtro; COUT = COUTA
  CMP0_SCR = B00010100; // Configurar interrupcion en un Rising EDGE
